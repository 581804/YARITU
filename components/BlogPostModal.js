                    ...
                    <div className="modal-body">
                        <div className="form-fields">
                            ...
                            <div className="form-group">
                                ...
                                <textarea id="blog-content" placeholder="Write the full blog post here. Leave a blank line between paragraphs." value={content} onChange={(e) => setContent(e.target.value)} rows={12} />
                            </div>
